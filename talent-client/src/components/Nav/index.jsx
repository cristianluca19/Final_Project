        ...
        <nav>
            <Container maxWidth="lg">
                <Grid container spacing={1}>
                    ...
                    <Grid className={classes.containerIcons} container item xs={3} sm={3} spacing={1}>
                        <IconButton className={classes.icons} label="Acount Circle" value="folder">
                            <AcountCircle />
                        </IconButton>
                        <IconButton className={classes.icons} label="Folder" value="folder" >
                            <FolderIcon />
                        </IconButton>
                        <IconButton className={classes.icons} label="Setting" value="folder">
                            <Settings />
                        </IconButton>
                    </Grid>
                </Grid>
