                    ...
                    row.selectorComents.map((campo) => (
                      <div>
                        ...
                        <TableRow >
                          ...
                          <EditIcon onClick={()=> props.handleClickOpen(campo.id, EDIT_COMMENT_CLICK_ACTION) }/>
                          <DeleteIcon onClick={()=> props.handleClickOpen(campo.id, DELETE_COMMENT_CLICK_ACTION) }/>
                        </TableRow>
                      </div>
                    ))}{' '}
                </TableCell>
                <h3 style={{ backgroundColor: '#cfd1d2' }}>
                  ...
                  { row.commentForRecruiter && row.commentForRecruiter.content  ?    
                      <div>
                        ...
                        <EditIcon onClick={()=> props.handleClickOpen(row.commentForRecruiter.id, EDIT_COMMENT_CLICK_ACTION) }/>
                        <DeleteIcon onClick={()=> props.handleClickOpen(row.commentForRecruiter.id, DELETE_COMMENT_CLICK_ACTION) }/>
                        </div>
                        :
                        <div> </div>
                }
